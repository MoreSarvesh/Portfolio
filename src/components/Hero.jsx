...
const Hero = () => {
  return (
    <section id="home" className="py-44 xl:py-14">
      ...
      <div className="ont-sans text-my-slate leading-relax mt-5 xl:text-xl xl:mt-7 xl:w-1/2">
      ...
      <div className="bg-my-green w-fit h-fit rounded-md">
        <a href="#about">
          <div className="px-5 py-2 bg-my-navy border rounded-md border-my-green text-my-green mt-12 text-xl font-mono hover:-translate-y-1 hover:-translate-x-1 duration-150 xl:px-5 xl:py-2 xl:mt-12 xl:text-2xl">
            Explore
          </div>
        </a>
      </div>
