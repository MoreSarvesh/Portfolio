...
const Tcontact = () => {
  return (
    <section className="py-44 flex flex-col items-center" id="contact">
      <h1 className="text-4xl font-sans font-bold text-my-lightest-slate leading-relaxed">
        Get In Touch
      </h1>
      <div className="text-lg font-sans text-my-slate leading-relax mt-7 text-center">
